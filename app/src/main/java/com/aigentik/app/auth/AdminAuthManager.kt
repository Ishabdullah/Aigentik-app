...
// AdminAuthManager v1.0 — ported verbatim from aigentik-android
// Handles admin authentication for remote command execution via SMS.
//
...
object AdminAuthManager {
    ...
    // Returns AdminCredentials if found, null otherwise
