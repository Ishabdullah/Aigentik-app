...
//
// Trigger: Gmail app posts a notification → AigentikNotificationListener.onNotificationPosted()
...
//   2. If no historyId   → listUnread() fallback (full unread scan, max 3 results)
...
object EmailMonitor {
    ...
    // Called by AigentikNotificationListener when Gmail app posts a notification.
